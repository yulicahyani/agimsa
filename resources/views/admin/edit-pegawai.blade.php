                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="jabatan" style="width: 100%;" required>
                                            ...
                                            <option value="Sales" {{ $pegawai->jabatan=='Sales'? 'selected':'' }}>Sales</option>
                                            <option value="Gudang" {{ $pegawai->jabatan=='Gudang'? 'selected':'' }}>Gudang</option>
                                            <option value="Pengirim" {{ $pegawai->jabatan=='Pengirim'? 'selected':'' }}>Pengirim</option>
