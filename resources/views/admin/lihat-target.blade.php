...
<head>
  ...
  <title>@yield('title', 'lihat target')</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Lihat Data Target Penjualan</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="card">
          ...
          <form>
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="form-group input-group">
                    ...
                    <input type="text" name="target-bulanan" class="form-control" value="100.000.000" disabled>
                  </div>
                </div>
              </div>
              <div class="row mt-4">
            ...
            <div class="card-footer">
                <a href="/target" class="btn btn-primary" title='back'>
                    Kembali
                </a>
              </div>
          </form>
