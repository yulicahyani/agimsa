...
<head>
    ...
    <title>@yield('title', 'pengiriman')</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Detail Pengiriman</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="/tambah-pengiriman" class="btn btn-success" title='tambah'>
                                        <p class="mb-auto">
                                            Tambah Pengiriman
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> {{ $item->status }} </td>
                                                <td>
                                                    <a href="{{ route('lihat-pengiriman', ['id'=>$item->id_pengiriman]) }}"
                                                        class="btn btn-info btn-sm btn-status" title='Lihat'>
                                                        <i class='fa fa-eye'></i>
                                                    </a>
                                                    <a href="{{ route('edit-pengiriman', ['id'=>$item->id_pengiriman]) }}  "
                                                        title='edit' class="btn btn-warning btn-sm">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a type="button" class="btn btn-danger btn-sm btn-delete"
                                                        onclick="idPengiriman({{$item->id_pengiriman}})" title='Delete'>
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Data Pengiriman akan dihapus. Anda yakin? </p>
                    </div>
        ...
        <div class="modal fade" id="modal-delete-confirm" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Data Pengiriman yang terhubung dengan data lainnya juga akan dihapus. Anda
                            yakin? </p>
                    </div>
                    <div class="modal-footer">
                        <form action="{{ route('delete-pengiriman') }}" method="post">
                            @csrf
